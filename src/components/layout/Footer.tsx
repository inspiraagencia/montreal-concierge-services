  ...
  return (
    <footer className="bg-primary-900 text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <div>
                <p className="font-heading font-bold text-white text-base leading-tight">Montreal Concierge</p>
                <p className="text-xs text-primary-400">Services</p>
              </div>
            </Link>
            ...
            <div className="space-y-2">
              <a
                ...
                className="flex items-center gap-2 text-primary-300 hover:text-accent-300 transition-colors text-sm"
              >
            ...
            <ul className="space-y-2.5">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-primary-300 hover:text-accent-300 transition-colors text-sm flex items-center gap-1.5"
                  >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {displayLocations.map((city) => (
                <li key={city} className="text-primary-300 text-sm flex items-center gap-1.5">
                  <svg className="w-3 h-3 text-primary-500" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="border-t border-primary-800">
        <div className="section-container py-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-primary-400">
          <p>
